...
use App\Filament\Resources\Caisse1Resource\Pages;
use App\Filament\Resources\Caisse1Resource\RelationManagers;
...
class Caisse1Resource extends Resource
{
    protected static ?string $model = Caisse1::class;

    protected static ?string $navigationIcon = 'heroicon-o-collection';

    protected static ?string $navigationGroup = 'Cloture Caisse - Anoual';

    protected static ?string $modelLabel = '12h-18h';

    protected static ?string $slug = 'Anoual1';
    ...
    {
        return [
            'index' => Pages\ListCaisse1s::route('/'),
            'create' => Pages\CreateCaisse1::route('/create'),
            'edit' => Pages\EditCaisse1::route('/{record}/edit'),
        ];
    }
